...
if (isset($_POST['submit'])) {
    ...
    $old_pass = sha1(htmlspecialchars($_POST['old_pass'], ENT_QUOTES, 'UTF-8'));
    $new_pass = sha1(htmlspecialchars($_POST['new_pass'], ENT_QUOTES, 'UTF-8'));
    $confirm_pass = sha1(htmlspecialchars($_POST['confirm_pass'], ENT_QUOTES, 'UTF-8'));
